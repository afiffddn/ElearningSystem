...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html"> E-Learning Unisel </a>
        ...
        <div class="wrapper">
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="menu-icon icon-bullhorn"></i> Notes And Assessment </a>
                                </li>
                            </ul>
                            <!--/.widget-nav-->
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a href="<?php echo web_root; ?>admin/modules/user/index.php"><i class="menu-icon icon-book"></i> Manage Admin </a></li> 
                            </ul>
                            <!--/.widget-nav-->
                            <ul class="widget widget-menu unstyled"> 
         ...
         <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2020 E-Learning Renovation </b> All rights reserved.
            </div>
        </div>
